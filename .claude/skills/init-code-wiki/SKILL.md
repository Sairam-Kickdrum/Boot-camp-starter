...
Per-ticket closeout (`closeout-feat-recorder`, AI-77/FD-711) is **not** a caller of either mode above — it writes `code-wiki/**` directly from the delivered diff on the PR's own branch, and never invokes this skill.
